...
from shapely_func import random_points_in_polygon_rejection, random_point_in_polygon, \
    random_points_in_polygon_triangulate, random_rectangle, draw_multipolygon
from shapely.geometry import Polygon, MultiPolygon
import time
from mesa_geo import GeoSpace, GeoAgent, AgentCreator
import math
from numpy.random import randint
from visualization import AnimatedEpidemicPlot
...
if __name__ == "__main__":
    ...
    model = EpidemicModel(N_tot=10000, N_inf=10, inf_radius = 1, inf_chance = 0.3, inf_duration = 10*24, mortality_rate = 0.05,
    ...
    # Rt = (total number of new infected)/(tot number of (non-new)infected)
